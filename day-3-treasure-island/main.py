...
lr = input("You are at a crossroads. Do you want to go left or right?\n")
if lr.lower() == "left":
    print("You have chosen wisely. You have reached a lake.")
    swim = input("Do you want to swim or wait?\n")
    if swim.lower() == "wait":
        print(
            "You have chosen wisely. You have reached a house with three doors."
        )
